...
public class DLFileEntryTypeUtil {
	 ...
	 * @throws NoSuchFileEntryTypeException if a matching document library file entry type could not be found
	 */
	public static DLFileEntryType findByG_D(long groupId, long dataDefinitionId)
		throws com.liferay.document.library.kernel.exception.
			NoSuchFileEntryTypeException {

		return getPersistence().findByG_D(groupId, dataDefinitionId);
	}
	 ...
	 * @return the matching document library file entry type, or <code>null</code> if a matching document library file entry type could not be found
	 */
	public static DLFileEntryType fetchByG_D(
		long groupId, long dataDefinitionId) {

		return getPersistence().fetchByG_D(groupId, dataDefinitionId);
	}
	...
	public static DLFileEntryType fetchByG_D(
		...
		return getPersistence().fetchByG_D(
	 ...
	 * @return the document library file entry type that was removed
	 */
	public static DLFileEntryType removeByG_D(
			long groupId, long dataDefinitionId)
		throws com.liferay.document.library.kernel.exception.
			NoSuchFileEntryTypeException {

		return getPersistence().removeByG_D(groupId, dataDefinitionId);
	}
	 ...
	 * @return the number of matching document library file entry types
	 */
	public static int countByG_D(long groupId, long dataDefinitionId) {
		return getPersistence().countByG_D(groupId, dataDefinitionId);
	}
