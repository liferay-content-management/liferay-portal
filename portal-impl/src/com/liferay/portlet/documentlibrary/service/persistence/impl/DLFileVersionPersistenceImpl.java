...
public class DLFileVersionPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByF_ST;
	private FinderPath _finderPathWithoutPaginationFindByF_ST;
	private FinderPath _finderPathCountByF_ST;
	private FinderPath _finderPathWithPaginationCountByF_ST;
	 ...
	 */
	@Override
	public List<DLFileVersion> findByF_ST(long fileEntryId, int status) {
		return findByF_ST(
			fileEntryId, status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<DLFileVersion> findByF_ST(
		long fileEntryId, int status, int start, int end) {

		return findByF_ST(fileEntryId, status, start, end, null);
	}
	...
	public List<DLFileVersion> findByF_ST(
		...
		try (SafeCloseable safeCloseable =
			...
			if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				...
				if (useFinderCache) {
					finderPath = _finderPathWithoutPaginationFindByF_ST;
					finderArgs = new Object[] {fileEntryId, status};
				}
			}
			else if (useFinderCache) {
				finderPath = _finderPathWithPaginationFindByF_ST;
				finderArgs = new Object[] {
					fileEntryId, status, start, end, orderByComparator
				};
			}
			...
			if (list == null) {
				...
				sb.append(_FINDER_COLUMN_F_ST_FILEENTRYID_2);

				sb.append(_FINDER_COLUMN_F_ST_STATUS_2);
	 ...
	 */
	@Override
	public DLFileVersion findByF_ST_First(
			long fileEntryId, int status,
			OrderByComparator<DLFileVersion> orderByComparator)
		throws NoSuchFileVersionException {

		DLFileVersion dlFileVersion = fetchByF_ST_First(
			fileEntryId, status, orderByComparator);
	 ...
	 */
	@Override
	public DLFileVersion fetchByF_ST_First(
		long fileEntryId, int status,
		OrderByComparator<DLFileVersion> orderByComparator) {

		List<DLFileVersion> list = findByF_ST(
			fileEntryId, status, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public DLFileVersion findByF_ST_Last(
			long fileEntryId, int status,
			OrderByComparator<DLFileVersion> orderByComparator)
		throws NoSuchFileVersionException {

		DLFileVersion dlFileVersion = fetchByF_ST_Last(
			fileEntryId, status, orderByComparator);
	 ...
	 */
	@Override
	public DLFileVersion fetchByF_ST_Last(
		long fileEntryId, int status,
		OrderByComparator<DLFileVersion> orderByComparator) {

		int count = countByF_ST(fileEntryId, status);
	 ...
	 */
	@Override
	public DLFileVersion[] findByF_ST_PrevAndNext(
			long fileVersionId, long fileEntryId, int status,
			OrderByComparator<DLFileVersion> orderByComparator)
		throws NoSuchFileVersionException {
		...
		try {
			...
			array[0] = getByF_ST_PrevAndNext(
				session, dlFileVersion, fileEntryId, status, orderByComparator,
				true);

			array[1] = dlFileVersion;

			array[2] = getByF_ST_PrevAndNext(
				session, dlFileVersion, fileEntryId, status, orderByComparator,
				false);
	...
	protected DLFileVersion getByF_ST_PrevAndNext(
		Session session, DLFileVersion dlFileVersion, long fileEntryId,
		int status, OrderByComparator<DLFileVersion> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public List<DLFileVersion> findByF_ST(long fileEntryId, int[] statuses) {
		return findByF_ST(
	...
	public List<DLFileVersion> findByF_ST(
		...
		return findByF_ST(fileEntryId, statuses, start, end, null);
	}
	...
	public List<DLFileVersion> findByF_ST(
		...
		try (SafeCloseable safeCloseable =
			...
			if (useFinderCache) {
				list = (List<DLFileVersion>)FinderCacheUtil.getResult(
					_finderPathWithPaginationFindByF_ST, finderArgs, this);
			...
			if (list == null) {
				...
				if (statuses.length > 0) {
					...
					sb.append(_FINDER_COLUMN_F_ST_STATUS_7);
				...
				try {
					...
					if (useFinderCache) {
						FinderCacheUtil.putResult(
							_finderPathWithPaginationFindByF_ST, finderArgs,
							list);
					}
				}
				catch (Exception exception) {
	 ...
	 */
	@Override
	public void removeByF_ST(long fileEntryId, int status) {
		for (DLFileVersion dlFileVersion :
				findByF_ST(
					fileEntryId, status, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	 ...
	 */
	@Override
	public int countByF_ST(long fileEntryId, int status) {
		try (SafeCloseable safeCloseable =
				CTPersistenceHelperUtil.setCTCollectionIdWithSafeCloseable(
					DLFileVersion.class)) {

			FinderPath finderPath = _finderPathCountByF_ST;
	 ...
	 */
	@Override
	public int countByF_ST(long fileEntryId, int[] statuses) {
		if (statuses == null) {
			statuses = new int[0];
		}
		else if (statuses.length > 1) {
		...
		try (SafeCloseable safeCloseable =
			...
			Long count = (Long)FinderCacheUtil.getResult(
				_finderPathWithPaginationCountByF_ST, finderArgs, this);
			...
			if (count == null) {
				...
				try {
					...
					FinderCacheUtil.putResult(
						_finderPathWithPaginationCountByF_ST, finderArgs,
						count);
				}
				catch (Exception exception) {
					throw processException(exception);
	...
	private static final String _FINDER_COLUMN_F_ST_FILEENTRYID_2 =
		"dlFileVersion.fileEntryId = ? AND ";

	private static final String _FINDER_COLUMN_F_ST_STATUS_2 =
		"dlFileVersion.status = ?";

	private static final String _FINDER_COLUMN_F_ST_STATUS_7 =
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByF_ST = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByF_ST",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByF_ST = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByF_ST",
			new String[] {Long.class.getName(), Integer.class.getName()},
			new String[] {"fileEntryId", "status"}, true);

		_finderPathCountByF_ST = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_ST",
			new String[] {Long.class.getName(), Integer.class.getName()},
			new String[] {"fileEntryId", "status"}, false);

		_finderPathWithPaginationCountByF_ST = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByF_ST",
			new String[] {Long.class.getName(), Integer.class.getName()},
			new String[] {"fileEntryId", "status"}, false);
