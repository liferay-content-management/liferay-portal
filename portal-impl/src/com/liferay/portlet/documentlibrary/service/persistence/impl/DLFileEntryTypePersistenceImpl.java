...
public class DLFileEntryTypePersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			FinderCacheUtil.removeResult(_finderPathCountByG_D, args);
			FinderCacheUtil.removeResult(_finderPathFetchByG_D, args);
		}
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByG_D = new FinderPath(
			DLFileEntryTypeImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByG_D",
