...
public class AssetVocabularyLocalServiceImpl
	...
	public AssetVocabulary deleteVocabulary(AssetVocabulary vocabulary)
		...
		if (FeatureFlagManagerUtil.isEnabled(
			...
			throw new SystemVocabularyException.MustNotDeleteSystemVocabulary(
	...
	private void _validateSystemVocabulary(
		...
		if ((Validator.isNotNull(externalReferenceCode) &&
			...
			throw new SystemVocabularyException.MustNotRenameSystemVocabulary(
				vocabulary.getVocabularyId());
		}
		...
		if (!Objects.equals(descriptionMap, vocabulary.getDescriptionMap()) ||
			...
			throw new SystemVocabularyException.MustNotModifySystemVocabulary(
				vocabulary.getVocabularyId());
		}
	}
