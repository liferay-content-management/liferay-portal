	...
	<div class="translation-import">
		...
		>
			<div class="translation-import-body-form">
				...
				<%
				boolean importTranslationResultsErrors = importTranslationResultsDisplayContext.getFailureMessagesCount() > 0;
				%>

				<c:if test="<%= importTranslationResultsDisplayContext.getSuccessMessagesCount() > 0 %>">
					<div>
						<div class="panel panel-secondary" role="tablist">
							<button aria-expanded="false" class="<%= importTranslationResultsErrors ? "collapsed" : StringPool.BLANK %> btn btn-unstyled collapse-icon collapse-icon-middle panel-header panel-header-link" role="tab" type="button">
						...
						<ul class="list-group list-group-no-bordered">
							...
							%>
								...
								<li class="list-group-item">
									<clay:content-row>
										<clay:content-col
											cssClass="lfr-portal-tooltip list-group-title mr-1"
											expand="<%= true %>"
										>
										...
										<clay:content-col
											cssClass="lfr-portal-tooltip text-right"
											expand="<%= true %>"
										>
