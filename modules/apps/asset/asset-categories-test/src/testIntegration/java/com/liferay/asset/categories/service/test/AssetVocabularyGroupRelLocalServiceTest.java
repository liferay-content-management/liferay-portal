...
public class AssetVocabularyGroupRelLocalServiceTest {
	...
	public void testSetAssetVocabularyGroupRels() throws Exception {
		_testSetAssetVocabularyGroupRelsForSystemVocabulary();
	...
	private void _testSetAssetVocabularyGroupRelsForSystemVocabulary()
		throws Exception {
		...
		AssertUtils.assertFailure(
			SystemVocabularyException.MustNotChangeSystemVocabularyGroupRels.
				class,
			StringBundler.concat(
				"The spaces of the system vocabulary ",
				assetVocabulary.getVocabularyId(), " cannot be changed"),
			() ->
				_assetVocabularyGroupRelLocalService.
