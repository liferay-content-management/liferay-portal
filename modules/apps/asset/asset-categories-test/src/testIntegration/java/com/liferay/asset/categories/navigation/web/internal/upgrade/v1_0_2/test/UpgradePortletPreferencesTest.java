...
public class UpgradePortletPreferencesTest {
	...
	@Test
	public void testUpgradePortletPreferencesWithCompanyAssets()
		throws Exception {
	...
	@Test
	public void testUpgradePortletPreferencesWithSomeVocabularies()
		throws Exception {
		...
		AssetVocabulary assetVocabulary3 = AssetTestUtil.addVocabulary(
			_group.getGroupId());
		...
		_assertUpgrade(
			HashMapBuilder.put(
				...
				StringUtil.merge(
					new Long[] {
						...
						assetVocabulary3.getVocabularyId()
					})
			).put(
				"displayStyleGroupId", String.valueOf(companyGroup.getGroupId())
			).build(),
			HashMapBuilder.put(
				...
				"assetVocabularyExternalReferenceCodes",
				assetVocabulary3.getExternalReferenceCode()
			).put(
				"assetVocabularyGroupExternalReferenceCodes",
				companyGroup.getExternalReferenceCode()
			).put(
