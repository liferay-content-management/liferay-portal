...
import com.liferay.journal.internal.upgrade.v6_1_10.DocumentLibraryDDMFieldAttributeUpgradeProcess;
...
import com.liferay.journal.internal.upgrade.v6_1_8.JournalFolderRestrictionTypeUpgradeProcess;
import com.liferay.journal.internal.upgrade.v6_1_9.DDMFieldAttributeUpgradeProcess;
...
public class JournalServiceUpgradeStepRegistrator
	...
	public void register(Registry registry) {
		...
		registry.register(
			...
			UpgradeProcessFactory.runSQL(
				StringBundler.concat(
					"update JournalFolder set statusByUserId = userId, ",
					"statusByUserName = userName, statusDate = modifiedDate ",
					"where statusByUserName is null")));

		registry.register("6.1.6", "6.1.7", new DummyUpgradeProcess());

		registry.register(
			"6.1.7", "6.1.8",
			new JournalFolderRestrictionTypeUpgradeProcess(
				_classNameLocalService));
		...
		registry.register(
			"6.1.9", "6.1.10",
			new DocumentLibraryDDMFieldAttributeUpgradeProcess(
				_classNameLocalService, _journalArticleImageUpgradeHelper));
	}
