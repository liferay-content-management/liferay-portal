...
public class JournalUserNotificationTest extends BaseUserNotificationTestCase {
	...
	@Test
	public void testAddArticleWithWorkflowForUrlConstant() throws Exception {
		...
		_assertJournalArticleNotificationsCount(2, _adminUser, 1);
	...
	private void _createUrlConstantWorkflow() throws Exception {
		try {
			...
			String content = _getJsonFromFile(
				"url-constant-workflow-definition.xml");
