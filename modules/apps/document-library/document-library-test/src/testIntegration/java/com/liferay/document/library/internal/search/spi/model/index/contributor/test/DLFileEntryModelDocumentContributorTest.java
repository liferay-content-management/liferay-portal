...
public class DLFileEntryModelDocumentContributorTest {
	...
	private void _testFileEntryMetadataAttributesBasicFileEntry()
		...
		Assert.assertEquals(0L, GetterUtil.getLong(document.get("height")));
		Assert.assertEquals(0L, GetterUtil.getLong(document.get("width")));
	}
	...
	private void _testFileEntryMetadataAttributesImageFileEntry()
		...
		DLFileEntry dlFileEntry = _addDLFileEntry(
			...
			FileUtil.getBytes(getClass(), "dependencies/100x100.png"));
		...
		Assert.assertEquals(100L, GetterUtil.getLong(document.get("height")));
		Assert.assertEquals(100L, GetterUtil.getLong(document.get("width")));
	}
