...
import com.liferay.document.library.internal.upgrade.v3_2_2.DLFileEntryCleanUpgradeProcess;
import com.liferay.document.library.internal.upgrade.v3_2_2.DLFolderCleanUpgradeProcess;
...
public class DLServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"3.2.2", "3.2.3",
			new DLFileEntryCleanUpgradeProcess(_classNameLocalService),
			new DLFolderCleanUpgradeProcess(_classNameLocalService));
	}
