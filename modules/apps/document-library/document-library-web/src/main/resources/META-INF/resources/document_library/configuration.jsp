		...
		<liferay-frontend:fieldset-group>
			...
			>
				<div class="form-group">
					...
					<div class="alert alert-warning <%= dlAdminDisplayContext.isRootFolderInTrash() ? "" : "hide" %>" id="<portlet:namespace />rootFolderInTrash">
					...
					selectFolderButton.addEventListener('click', (event) => {
						Liferay.Util.getOpener().Liferay.Util.openSelectionModal({
							...
							onSelect: function (selectedItem) {
								...
								var warningMessage = document.querySelector(
