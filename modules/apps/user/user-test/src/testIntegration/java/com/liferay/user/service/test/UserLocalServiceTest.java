...
public class UserLocalServiceTest {
	...
	@Test
	public void testSearchBySocialCount() throws Exception {
		int usersCount1 = _userLocalService.searchBySocialCount(
			TestPropsValues.getCompanyId(), null, null, null);

		UserTestUtil.addUser();

		int usersCount2 = _userLocalService.searchBySocialCount(
			TestPropsValues.getCompanyId(), null, null, null);

		Assert.assertEquals(usersCount1 + 1, usersCount2);

		_testSearchBySocialCountWithGroup();
		_testSearchBySocialCountWithUserGroup();
		_testSearchBySocialCountWithGroupAndUserGroup();
	}
	...
	private void _testSearchBySocialCountWithGroup() throws Exception {
		Group group = GroupTestUtil.addGroup();
	...
	private void _testSearchBySocialCountWithGroupAndUserGroup()
		throws Exception {
	...
	private void _testSearchBySocialCountWithUserGroup() throws Exception {
		User user = UserTestUtil.addUser();
