...
public abstract class BaseUserGroupResourceImpl
	implements EntityModelResource, UserGroupResource,
			   ...
			   VulcanCRUDItemDelegate<UserGroup> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-admin-user/v1.0/asset-libraries/{assetLibraryId}/user-groups'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrieves the asset library user groups. Results can be paginated, filtered, searched, and sorted."
	)
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/asset-libraries/{assetLibraryId}/user-groups")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-user/v1.0/asset-libraries/{assetLibraryId}/user-groups/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Path(
		"/asset-libraries/{assetLibraryId}/user-groups/export-batch"
	)
	@javax.ws.rs.POST
	...
	public Response postAssetLibraryUserGroupsPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				UserGroup.class.getName(), callbackURL, contentType, fieldNames)
		).build();
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-admin-user/v1.0/user-accounts/{userAccountId}/user-groups'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-user/v1.0/user-groups/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-admin-user/v1.0/user-groups/by-external-reference-code/{externalReferenceCode}/user-group-users'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-user/v1.0/user-groups/by-external-reference-code/{externalReferenceCode}/user-group-users'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@Override
	public UserGroup getItem(Long id) throws Exception {
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<UserGroup>, UnsafeConsumer<UserGroup, Exception>,
