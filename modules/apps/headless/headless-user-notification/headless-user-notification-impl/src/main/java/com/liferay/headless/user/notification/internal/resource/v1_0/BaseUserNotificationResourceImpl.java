...
public abstract class BaseUserNotificationResourceImpl
	...
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrieves the current user notifications. Results can be paginated, filtered, searched, and sorted."
	)
	...
	@Override
	public Page<UserNotification> read(
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<java.util.Collection<UserNotification>,
