...
@Generated("")
@GraphQLName(
	description = "Represents a object entry folder brief.",
	value = "ObjectEntryFolderBrief"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ObjectEntryFolderBrief")
public class ObjectEntryFolderBrief implements Serializable {

	public static ObjectEntryFolderBrief toDTO(String json) {
		return ObjectMapperUtil.readValue(ObjectEntryFolderBrief.class, json);
	}

	public static ObjectEntryFolderBrief unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			ObjectEntryFolderBrief.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof ObjectEntryFolderBrief)) {
			return false;
		}

		ObjectEntryFolderBrief objectEntryFolderBrief =
			(ObjectEntryFolderBrief)object;

		return Objects.equals(toString(), objectEntryFolderBrief.toString());
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.object.dto.v1_0.ObjectEntryFolderBrief",
		name = "x-class-name"
	)
