...
public interface SimilarityClusterResource {
	...
	public static class Builder {
		...
		public SimilarityClusterResource build() {
			return new SimilarityClusterResourceImpl(this);
		}
	...
	public static class SimilarityClusterResourceImpl
		...
		public Page<SimilarityCluster> getSimilarityClustersPage(
			...
			try {
				return Page.of(content, SimilarityClusterSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private SimilarityClusterResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SimilarityClusterResource.class.getName());
