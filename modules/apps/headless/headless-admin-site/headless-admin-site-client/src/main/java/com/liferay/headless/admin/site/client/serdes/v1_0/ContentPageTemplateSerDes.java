	...
	public static String toJSON(ContentPageTemplate contentPageTemplate) {
		...
		if (contentPageTemplate.getKeywords() != null) {
			...
			for (int i = 0; i < contentPageTemplate.getKeywords().length; i++) {
				sb.append(_toJSON(contentPageTemplate.getKeywords()[i]));
		...
		if (contentPageTemplate.getTaxonomyCategoryBriefs() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			for (int i = 0;
				 i < contentPageTemplate.getTaxonomyCategoryBriefs().length;
				 i++) {

				sb.append(
					String.valueOf(
						contentPageTemplate.getTaxonomyCategoryBriefs()[i]));
	...
	public static Map<String, String> toMap(
		...
		if (contentPageTemplate.getTaxonomyCategoryBriefs() == null) {
			...
			map.put(
				...
				String.valueOf(
					contentPageTemplate.getTaxonomyCategoryBriefs()));
		}
	...
	public static class ContentPageTemplateJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "creator")) {
				...
				if (jsonParserFieldValue != null) {
					contentPageTemplate.setKeywords(
				...
				if (jsonParserFieldValue != null) {
					...
					contentPageTemplate.setTaxonomyCategoryBriefs(
