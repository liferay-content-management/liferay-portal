...
public interface SiteTemplateResource {
	...
	public static class Builder {
		...
		public SiteTemplateResource build() {
			return new SiteTemplateResourceImpl(this);
		}
	...
	public static class SiteTemplateResourceImpl
		...
		public Page<SiteTemplate> getSiteTemplatesPage(
			...
			try {
				return Page.of(content, SiteTemplateSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-site/v1.0/site-templates");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-site/v1.0/site-templates/export-batch");
		...
		private SiteTemplateResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SiteTemplateResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:-1243033507