...
public abstract class BaseSitePageResourceImpl
	 ...
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/site-pages/{sitePageExternalReferenceCode}'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/site-pages/{sitePageExternalReferenceCode}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/site-pages/{sitePageExternalReferenceCode}/permissions'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<Permission> getSiteSitePagePermissionsPage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("siteExternalReferenceCode")
			String siteExternalReferenceCode,
		...
		return toPermissionPage(
			HashMapBuilder.put(
				...
				addAction(
					...
					"getSiteSitePagePermissionsPage", null, resourceName,
					groupId)
			).put(
				"replace",
				addAction(
					ActionKeys.PERMISSIONS, resourceId,
					"putSiteSitePagePermissionsPage", null, resourceName,
					groupId)
			).build(),
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteExternalReferenceCode}/site-pages")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public final Page<SitePage> getSiteSitePagesPage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("siteExternalReferenceCode")
			String siteExternalReferenceCode,
	...
	public SitePage patchSiteSitePage(
		...
		SitePage existingSitePage = getSiteSitePage(
			siteExternalReferenceCode, sitePageExternalReferenceCode);
		...
		if (sitePage.getDateModified() != null) {
			existingSitePage.setDateModified(sitePage.getDateModified());
		}

		if (sitePage.getDatePublished() != null) {
			existingSitePage.setDatePublished(sitePage.getDatePublished());
		}

		if (sitePage.getExternalReferenceCode() != null) {
			existingSitePage.setExternalReferenceCode(
				sitePage.getExternalReferenceCode());
		}

		if (sitePage.getFriendlyUrlPath_i18n() != null) {
			existingSitePage.setFriendlyUrlPath_i18n(
				sitePage.getFriendlyUrlPath_i18n());
		}

		if (sitePage.getKeywords() != null) {
			existingSitePage.setKeywords(sitePage.getKeywords());
		}
		...
		if (sitePage.getPermissions() != null) {
			existingSitePage.setPermissions(sitePage.getPermissions());
		}

		if (sitePage.getType() != null) {
			existingSitePage.setType(sitePage.getType());
		}

		if (sitePage.getUuid() != null) {
			existingSitePage.setUuid(sitePage.getUuid());
		}

		if (sitePage.getViewableBy() != null) {
			existingSitePage.setViewableBy(sitePage.getViewableBy());
		}
	...
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public final SitePage postSiteSitePage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("siteExternalReferenceCode")
			String siteExternalReferenceCode,
		...
		if (permissions != null) {
			Page<Permission> permissionsPage = putSiteSitePagePermissionsPage(
				siteExternalReferenceCode,
				postSitePage.getExternalReferenceCode(), permissions);

			postSitePage.setPermissions(
				() -> NestedFieldsSupplier.supply(
					"permissions",
					nestedField -> {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/site-pages/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.Path("/sites/{siteExternalReferenceCode}/site-pages/batch")
	@jakarta.ws.rs.POST
	...
	public Response postSiteSitePageBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				SitePage.class.getName(), callbackURL, null, object)
		).build();
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/site-pages/{sitePageExternalReferenceCode}/page-specifications' -d $'{"draftContentPageSpecificationExternalReferenceCode": ___, "pageExperiences": ___, "settings": ___, "siteTemplatePageSpecificationExternalReferenceCode": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/site-pages/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/site-pages/export-batch"
	)
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	public Response postSiteSitePagesPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				SitePage.class.getName(), callbackURL, contentType, fieldNames)
		).build();
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/site-pages/{sitePageExternalReferenceCode}/permissions'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
