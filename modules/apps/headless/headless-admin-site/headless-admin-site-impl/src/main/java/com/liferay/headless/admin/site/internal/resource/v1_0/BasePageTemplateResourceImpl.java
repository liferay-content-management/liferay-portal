...
public abstract class BasePageTemplateResourceImpl
	...
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<Permission> getSitePageTemplatePermissionsPage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("siteExternalReferenceCode")
			String siteExternalReferenceCode,
		...
		return toPermissionPage(
			HashMapBuilder.put(
				...
				addAction(
					...
					"getSitePageTemplatePermissionsPage", null, resourceName,
					groupId)
			).put(
				"replace",
				addAction(
					ActionKeys.PERMISSIONS, resourceId,
					"putSitePageTemplatePermissionsPage", null, resourceName,
					groupId)
			).build(),
	...
	protected abstract Page<PageTemplate> doGetSitePageTemplatesPage(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteExternalReferenceCode}/page-templates")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public final Page<PageTemplate> getSitePageTemplatesPage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("siteExternalReferenceCode")
			String siteExternalReferenceCode,
		...
		Page<PageTemplate> pageTemplatesPage = doGetSitePageTemplatesPage(
			siteExternalReferenceCode, search, aggregation, filter, pagination,
			sorts);

		for (PageTemplate pageTemplate : pageTemplatesPage.getItems()) {
	...
	public PageTemplate patchSitePageTemplate(
		...
		PageTemplate existingPageTemplate = getSitePageTemplate(
			siteExternalReferenceCode, pageTemplateExternalReferenceCode);
		...
		if (pageTemplate.getPermissions() != null) {
			existingPageTemplate.setPermissions(pageTemplate.getPermissions());
		}
		...
		return putSitePageTemplate(
			siteExternalReferenceCode, pageTemplateExternalReferenceCode,
			existingPageTemplate);
	}

	protected abstract PageTemplate doPostSitePageTemplate(
	...
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public final PageTemplate postSitePageTemplate(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("siteExternalReferenceCode")
			String siteExternalReferenceCode,
		...
		PageTemplate postPageTemplate = doPostSitePageTemplate(
		...
		if (permissions != null) {
			Page<Permission> permissionsPage =
				putSitePageTemplatePermissionsPage(
					siteExternalReferenceCode,
					postPageTemplate.getExternalReferenceCode(), permissions);

			postPageTemplate.setPermissions(
				() -> NestedFieldsSupplier.supply(
					"permissions",
					nestedField -> {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/page-templates/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/page-templates/batch"
	)
	@jakarta.ws.rs.POST
	...
	public Response postSitePageTemplateBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				PageTemplate.class.getName(), callbackURL, null, object)
		).build();
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/page-templates/{pageTemplateExternalReferenceCode}/page-specifications' -d $'{"draftContentPageSpecificationExternalReferenceCode": ___, "pageExperiences": ___, "settings": ___, "siteTemplatePageSpecificationExternalReferenceCode": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-site/v1.0/sites/{siteExternalReferenceCode}/page-templates/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/page-templates/export-batch"
	)
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	public Response postSitePageTemplatesPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				PageTemplate.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
	...
	@jakarta.ws.rs.PUT
	@Override
	public Page<Permission> putSitePageTemplatePermissionsPage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("siteExternalReferenceCode")
			String siteExternalReferenceCode,
	...
	public void create(
		...
		UnsafeFunction<PageTemplate, PageTemplate, Exception>
			pageTemplateUnsafeFunction = null;
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "INSERT")) {
			if (parameters.containsKey("siteExternalReferenceCode")) {
				pageTemplateUnsafeFunction =
					pageTemplate -> postSitePageTemplate(
		...
		if (pageTemplateUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for PageTemplate");
		}

		if (contextBatchUnsafeBiConsumer != null) {
			contextBatchUnsafeBiConsumer.accept(
				pageTemplates, pageTemplateUnsafeFunction);
		}
		else if (contextBatchUnsafeConsumer != null) {
			contextBatchUnsafeConsumer.accept(
				pageTemplates, pageTemplateUnsafeFunction::apply);
		}
		else {
			for (PageTemplate pageTemplate : pageTemplates) {
				pageTemplateUnsafeFunction.apply(pageTemplate);
			}
		}
	}
	...
	public Page<PageTemplate> read(
		...
		if (parameters.containsKey("siteExternalReferenceCode")) {
			return getSitePageTemplatesPage(
