...
@Generated("")
@GraphQLName(
	description = "Represents a persisted Content Set (AssetListEntry) exposed for discovery by the Item Selector.",
	value = "AssetListEntry"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "AssetListEntry")
public class AssetListEntry implements Serializable {

	public static AssetListEntry toDTO(String json) {
		return ObjectMapperUtil.readValue(AssetListEntry.class, json);
	}

	public static AssetListEntry unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(AssetListEntry.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The AssetListEntry's primary key. Equal to classPK; exposed explicitly because the field name is meaningful to callers reading the DTO."
	)
	public Long getAssetListEntryId() {
		if (_assetListEntryIdSupplier != null) {
			assetListEntryId = _assetListEntryIdSupplier.get();

			_assetListEntryIdSupplier = null;
		}
	...
	public void setAssetListEntryId(
		...
		_assetListEntryIdSupplier = () -> {
			try {
				return assetListEntryIdUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<Long> _assetListEntryIdSupplier;
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The AssetListEntry's id (=assetListEntryId), kept as classPK for legacy InfoListItemSelectorReturnType parity."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Standard Liferay headless field for portable cross-system references."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.delivery.dto.v1_0.AssetListEntry",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1651873942