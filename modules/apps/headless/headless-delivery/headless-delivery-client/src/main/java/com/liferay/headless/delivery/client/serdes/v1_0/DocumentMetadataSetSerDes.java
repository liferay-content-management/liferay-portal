...
public class DocumentMetadataSetSerDes {
	...
	public static String toJSON(DocumentMetadataSet documentMetadataSet) {
		...
		if (documentMetadataSet.getContentStructureFields() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			for (int i = 0;
				 i < documentMetadataSet.getContentStructureFields().length;
				 i++) {

				sb.append(
					String.valueOf(
						documentMetadataSet.getContentStructureFields()[i]));

				if ((i + 1) <
						documentMetadataSet.
							getContentStructureFields().length) {
	...
	public static Map<String, String> toMap(
		...
		if (documentMetadataSet.getContentStructureFields() == null) {
			...
			map.put(
				...
				String.valueOf(
					documentMetadataSet.getContentStructureFields()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "actions")) {
				...
				if (jsonParserFieldValue != null) {
					...
					documentMetadataSet.setContentStructureFields(
