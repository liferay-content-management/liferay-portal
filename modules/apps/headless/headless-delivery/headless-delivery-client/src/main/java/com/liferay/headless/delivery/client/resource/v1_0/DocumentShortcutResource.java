...
public interface DocumentShortcutResource {
	...
	public HttpInvoker.HttpResponse
			postAssetLibraryDocumentShortcutsPageExportBatchHttpResponse(
				Long assetLibraryId, String callbackURL, String contentType,
				String fieldNames)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getDocumentShortcutHttpResponse(
	...
	public HttpInvoker.HttpResponse patchDocumentShortcutHttpResponse(
			Long documentShortcutId, DocumentShortcut documentShortcut)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putDocumentShortcutHttpResponse(
			Long documentShortcutId, DocumentShortcut documentShortcut)
		throws Exception;
	...
	public static class Builder {
		...
		public DocumentShortcutResource build() {
			return new DocumentShortcutResourceImpl(this);
		}
	...
	public static class DocumentShortcutResourceImpl
		...
		public Page<DocumentShortcut> getAssetLibraryDocumentShortcutsPage(
			...
			try {
				return Page.of(content, DocumentShortcutSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public DocumentShortcut getDocumentShortcut(Long documentShortcutId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getDocumentShortcutHttpResponse(documentShortcutId);
		...
		public DocumentShortcut patchDocumentShortcut(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchDocumentShortcutHttpResponse(
		...
		public DocumentShortcut putDocumentShortcut(
			...
			HttpInvoker.HttpResponse httpResponse =
				putDocumentShortcutHttpResponse(
					documentShortcutId, documentShortcut);
		...
		public DocumentShortcut postSiteDocumentShortcut(
			...
			HttpInvoker.HttpResponse httpResponse =
				postSiteDocumentShortcutHttpResponse(siteId, documentShortcut);
		...
		private DocumentShortcutResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			DocumentShortcutResource.class.getName());
