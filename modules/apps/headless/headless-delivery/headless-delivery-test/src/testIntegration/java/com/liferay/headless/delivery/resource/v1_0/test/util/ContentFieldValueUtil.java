 ...
 */
public class ContentFieldValueUtil {
	...
	public static Value getValue(
		...
		if ((contentFieldValue == null) ||
			Validator.isNull(ddmFormField.getDataType())) {
	...
	private static String _getOptionValues(
		...
		if (!ddmFormField.isMultiple() &&
			!Objects.equals(
				DDMFormFieldType.CHECKBOX_MULTIPLE, ddmFormField.getType())) {
	...
	private static Value _toDateValue(
		...
		if (ddmFormField.isLocalizable()) {
			return _toLocalizedValue(
				contentFieldValue, localizedContentFieldValues,
				ContentFieldValueUtil::_toDateString, preferredLocale);
		}
