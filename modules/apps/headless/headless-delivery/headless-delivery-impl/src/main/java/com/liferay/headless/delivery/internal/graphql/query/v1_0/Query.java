...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {documentMetadataSet(documentMetadataSetId: ___){actions, assetLibraryKey, availableLanguages, contentStructureFields, dateCreated, dateModified, description, description_i18n, id, name, name_i18n}}"}' -u 'test@liferay.com:test'
	 */
