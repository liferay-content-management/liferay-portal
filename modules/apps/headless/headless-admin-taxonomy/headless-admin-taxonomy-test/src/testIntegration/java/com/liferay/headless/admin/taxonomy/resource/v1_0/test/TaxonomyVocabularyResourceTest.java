...
public class TaxonomyVocabularyResourceTest
	...
	public void testPostSiteTaxonomyVocabulary() throws Exception {
		...
		_testPostSiteTaxonomyVocabularyInvalidAssetType();
		_testPostSiteTaxonomyVocabularyInvalidAssetSubtype();
	}
	...
	private void _testPostSiteTaxonomyVocabularyInvalidAssetSubtype()
		throws Exception {

		String randomAssetSubtype = RandomTestUtil.randomString();
		...
		try (LogCapture logCapture = LoggerTestUtil.configureLog4JLogger(
			...
			Assert.assertEquals(
				StringBundler.concat(
					"Invalid subtype ", randomAssetSubtype,
					" for this context"),
				logEntry.getMessage());
		}
	...
	private void _testPostSiteTaxonomyVocabularyInvalidAssetType()
		throws Exception {

		String randomAssetType = RandomTestUtil.randomString();
