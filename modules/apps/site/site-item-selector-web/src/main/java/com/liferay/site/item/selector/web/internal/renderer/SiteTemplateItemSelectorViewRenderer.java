 ...
 * @author Roberto Díaz
 */
public class SiteTemplateItemSelectorViewRenderer {

	public SiteTemplateItemSelectorViewRenderer(
	...
	public void renderHTML(
			...
			SiteItemSelectorCriterion t, PortletURL portletURL,
		...
		SiteTemplateItemSelectorViewDisplayContext
			siteTemplateItemSelectorViewDisplayContext =
				new SiteTemplateItemSelectorViewDisplayContext(
