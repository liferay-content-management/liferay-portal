...
import com.liferay.site.cms.site.initializer.internal.helper.SiteInitializerHelper;
...
public class CMSFeatureFlagListener implements FeatureFlagListener {
	...
	public void onValue(
		...
		if (enabled && Objects.equals(featureFlagKey, "LPD-17564")) {
			...
			try {
				...
				_siteInitializerHelper.initialize(companyId);
			}
	...
	@Reference
	private SiteInitializerHelper _siteInitializerHelper;
