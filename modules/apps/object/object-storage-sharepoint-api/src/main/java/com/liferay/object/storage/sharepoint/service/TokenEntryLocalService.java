...
/**
 * Provides the local service interface for TokenEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jürgen Kappler
 * @see TokenEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TokenEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.object.storage.sharepoint.service.impl.TokenEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the token entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TokenEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TokenEntry createTokenEntry(long tokenEntryId);
	...
	public TokenEntry deleteTokenEntry(long tokenEntryId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TokenEntry fetchTokenEntry(long tokenEntryId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TokenEntry getTokenEntry(long tokenEntryId) throws PortalException;
