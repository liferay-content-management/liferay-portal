...
public class ObjectEntryAssetRendererFactoryTest {
	...
	public void testGetTypeName() throws Exception {
		...
		String typeName = _objectEntryAssetRendererFactory.getTypeName(
			LocaleUtil.getDefault());

		Assert.assertTrue(typeName.contains("(CMS)"));
		...
		typeName = _objectEntryAssetRendererFactory.getTypeName(
			LocaleUtil.getDefault());

		Assert.assertFalse(typeName.contains("(CMS)"));
	}
