 ...
 */
@Generated("")
@GraphQLName("RestoreObjectBulkSelectionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "RestoreObjectBulkSelectionAction")
public class RestoreObjectBulkSelectionAction
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.RestoreObjectBulkSelectionAction",
		name = "x-class-name"
	)
