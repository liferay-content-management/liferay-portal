 ...
 */
@Generated("")
public class RestoreObjectBulkSelectionActionSerDes {

	public static RestoreObjectBulkSelectionAction toDTO(String json) {
	...
	public static String toJSON(
		...
		if (restoreObjectBulkSelectionAction.getType() != null) {
			...
			sb.append("\"");
			sb.append(restoreObjectBulkSelectionAction.getType());
			sb.append("\"");
		}
	...
	public static class RestoreObjectBulkSelectionActionJSONParser
		extends BaseJSONParser<RestoreObjectBulkSelectionAction> {

		@Override
		protected RestoreObjectBulkSelectionAction createDTO() {
			return new RestoreObjectBulkSelectionAction();
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "bulkActionItems")) {
				if (jsonParserFieldValue != null) {
					...
					restoreObjectBulkSelectionAction.setBulkActionItems(
						bulkActionItemsArray);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "selectionScope")) {
				if (jsonParserFieldValue != null) {
					restoreObjectBulkSelectionAction.setSelectionScope(
				...
				if (jsonParserFieldValue != null) {
					restoreObjectBulkSelectionAction.setType(
						RestoreObjectBulkSelectionAction.Type.create(
							(String)jsonParserFieldValue));
				}
			}
		}
