...
public class LayoutSEOEntryLocalServiceImpl
	...
	public LayoutSEOEntry updateLayoutSEOEntry(
			long userId, long groupId, boolean privateLayout, long layoutId,
			long copyDDMStorageId, boolean canonicalURLEnabled,
		...
		if (layoutSEOEntry == null) {
			return _addLayoutSEOEntry(
				userId, groupId, privateLayout, layoutId, copyDDMStorageId,
	...
	private LayoutSEOEntry _addLayoutSEOEntry(
		...
		long ddmStorageId = _updateDDMStorage(
			...
			ddmStructure.getStructureId(), copyDDMStorageId, serviceContext);
