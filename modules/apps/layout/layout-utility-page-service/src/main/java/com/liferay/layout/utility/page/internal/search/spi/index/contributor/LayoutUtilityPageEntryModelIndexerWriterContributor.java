...
public class LayoutUtilityPageEntryModelIndexerWriterContributor
    ...
    public void customize(BatchIndexingActionable batchIndexingActionable, ModelIndexerWriterDocumentHelper modelIndexerWriterDocumentHelper) {
        batchIndexingActionable.setPerformActionMethod(
                (LayoutUtilityPageEntry layoutUtilityPageEntry) -> batchIndexingActionable.addDocuments(
                        modelIndexerWriterDocumentHelper.getDocument(layoutUtilityPageEntry)));
    }
    ...
    public BatchIndexingActionable getBatchIndexingActionable() {
        return _dynamicQueryBatchIndexingActionableFactory.
                getBatchIndexingActionable(
                        _layoutUtilityPageEntryLocalService.getIndexableActionableDynamicQuery());
    }
