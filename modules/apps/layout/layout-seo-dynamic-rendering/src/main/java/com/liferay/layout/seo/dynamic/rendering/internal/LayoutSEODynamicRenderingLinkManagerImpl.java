...
package com.liferay.layout.seo.dynamic.rendering.internal;
...
public class LayoutSEODynamicRenderingLinkManagerImpl
	...
	public List<LayoutSEOLink> getLocalizedLayoutSEOLinks(
		...
		if (prerenderPathList.contains(layout.getFriendlyURL())) {
