package com.liferay.layout.page.template.internal.search.spi.query.contributor;
...
@Component(
        property = {
                "indexer.class.name=com.liferay.layout.page.template.model.LayoutPageTemplateEntry"
        },
        service = ModelPreFilterContributor.class
)
public class LayoutPageTemplateEntryModelPreFilterContributor implements ModelPreFilterContributor {
    ...
    private void _filterByTypes(BooleanFilter booleanFilter, SearchContext searchContext) {
        String[] types = GetterUtil.getStringValues(searchContext.getAttribute("types"));
