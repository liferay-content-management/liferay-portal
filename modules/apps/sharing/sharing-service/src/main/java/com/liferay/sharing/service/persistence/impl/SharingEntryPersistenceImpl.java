...
public class SharingEntryPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByTUG_C_C;
	private FinderPath _finderPathWithoutPaginationFindByTUG_C_C;
	private FinderPath _finderPathCountByTUG_C_C;
	private FinderPath _finderPathWithPaginationCountByTUG_C_C;

	/**
	 * Returns all the sharing entries where toUserGroupId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 ...
	 */
	@Override
	public List<SharingEntry> findByTUG_C_C(
		long toUserGroupId, long classNameId, long classPK) {

		return findByTUG_C_C(
			toUserGroupId, classNameId, classPK, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the sharing entries where toUserGroupId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SharingEntryModelImpl</code>.
	 * </p>
	...
	@Override
	public List<SharingEntry> findByTUG_C_C(
		long toUserGroupId, long classNameId, long classPK, int start,
		int end) {

		return findByTUG_C_C(
			toUserGroupId, classNameId, classPK, start, end, null);
	}

	/**
	 * Returns an ordered range of all the sharing entries where toUserGroupId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SharingEntryModelImpl</code>.
	 * </p>
	...
	@Override
	public List<SharingEntry> findByTUG_C_C(
		long toUserGroupId, long classNameId, long classPK, int start, int end,
		OrderByComparator<SharingEntry> orderByComparator) {

		return findByTUG_C_C(
			toUserGroupId, classNameId, classPK, start, end, orderByComparator,
			true);
	}
	...
	public List<SharingEntry> findByTUG_C_C(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByTUG_C_C;
				finderArgs = new Object[] {toUserGroupId, classNameId, classPK};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByTUG_C_C;
			finderArgs = new Object[] {
				toUserGroupId, classNameId, classPK, start, end,
				orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_TUG_C_C_TOUSERGROUPID_2);

			sb.append(_FINDER_COLUMN_TUG_C_C_CLASSNAMEID_2);

			sb.append(_FINDER_COLUMN_TUG_C_C_CLASSPK_2);
	...
	/**
	 * Returns the first sharing entry in the ordered set where toUserGroupId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param toUserGroupId the to user group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public SharingEntry findByTUG_C_C_First(
			long toUserGroupId, long classNameId, long classPK,
			OrderByComparator<SharingEntry> orderByComparator)
		throws NoSuchEntryException {

		SharingEntry sharingEntry = fetchByTUG_C_C_First(
			toUserGroupId, classNameId, classPK, orderByComparator);
	 ...
	 */
	@Override
	public SharingEntry fetchByTUG_C_C_First(
		long toUserGroupId, long classNameId, long classPK,
		OrderByComparator<SharingEntry> orderByComparator) {

		List<SharingEntry> list = findByTUG_C_C(
			toUserGroupId, classNameId, classPK, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last sharing entry in the ordered set where toUserGroupId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param toUserGroupId the to user group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public SharingEntry findByTUG_C_C_Last(
			long toUserGroupId, long classNameId, long classPK,
			OrderByComparator<SharingEntry> orderByComparator)
		throws NoSuchEntryException {

		SharingEntry sharingEntry = fetchByTUG_C_C_Last(
			toUserGroupId, classNameId, classPK, orderByComparator);
	 ...
	 */
	@Override
	public SharingEntry fetchByTUG_C_C_Last(
		long toUserGroupId, long classNameId, long classPK,
		OrderByComparator<SharingEntry> orderByComparator) {

		int count = countByTUG_C_C(toUserGroupId, classNameId, classPK);
		...
		List<SharingEntry> list = findByTUG_C_C(
			toUserGroupId, classNameId, classPK, count - 1, count,
			orderByComparator);
	...
	/**
	 * Returns the sharing entries before and after the current sharing entry in the ordered set where toUserGroupId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param sharingEntryId the primary key of the current sharing entry
	 * @param toUserGroupId the to user group ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public SharingEntry[] findByTUG_C_C_PrevAndNext(
			long sharingEntryId, long toUserGroupId, long classNameId,
			long classPK, OrderByComparator<SharingEntry> orderByComparator)
		throws NoSuchEntryException {
		...
		try {
			...
			array[0] = getByTUG_C_C_PrevAndNext(
				session, sharingEntry, toUserGroupId, classNameId, classPK,
				orderByComparator, true);

			array[1] = sharingEntry;

			array[2] = getByTUG_C_C_PrevAndNext(
				session, sharingEntry, toUserGroupId, classNameId, classPK,
	...
	protected SharingEntry getByTUG_C_C_PrevAndNext(
		Session session, SharingEntry sharingEntry, long toUserGroupId,
		long classNameId, long classPK,
		OrderByComparator<SharingEntry> orderByComparator, boolean previous) {
	...
	/**
	 * Returns all the sharing entries where toUserGroupId = any &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SharingEntryModelImpl</code>.
	 * </p>
	 *
	 * @param toUserGroupIds the to user group IDs
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 * @return the matching sharing entries
	 */
	@Override
	public List<SharingEntry> findByTUG_C_C(
		long[] toUserGroupIds, long classNameId, long classPK) {

		return findByTUG_C_C(
			toUserGroupIds, classNameId, classPK, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the sharing entries where toUserGroupId = any &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SharingEntryModelImpl</code>.
	 * </p>
	...
	@Override
	public List<SharingEntry> findByTUG_C_C(
		long[] toUserGroupIds, long classNameId, long classPK, int start,
		int end) {

		return findByTUG_C_C(
			toUserGroupIds, classNameId, classPK, start, end, null);
	}

	/**
	 * Returns an ordered range of all the sharing entries where toUserGroupId = any &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SharingEntryModelImpl</code>.
	 * </p>
	...
	public List<SharingEntry> findByTUG_C_C(
		...
		return findByTUG_C_C(
			toUserGroupIds, classNameId, classPK, start, end, orderByComparator,
			true);
	}

	/**
	 * Returns an ordered range of all the sharing entries where toUserGroupId = &#63; and classNameId = &#63; and classPK = &#63;, optionally using the finder cache.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>SharingEntryModelImpl</code>.
	 * </p>
	...
	public List<SharingEntry> findByTUG_C_C(
		...
		if (toUserGroupIds == null) {
			toUserGroupIds = new long[0];
		}
		else if (toUserGroupIds.length > 1) {
			toUserGroupIds = ArrayUtil.sortedUnique(toUserGroupIds);
		}

		if (toUserGroupIds.length == 1) {
			return findByTUG_C_C(
				toUserGroupIds[0], classNameId, classPK, start, end,
				orderByComparator);
		}
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderArgs = new Object[] {
					StringUtil.merge(toUserGroupIds), classNameId, classPK
				};
			}
		}
		else if (useFinderCache) {
			finderArgs = new Object[] {
				StringUtil.merge(toUserGroupIds), classNameId, classPK, start,
		...
		if (useFinderCache) {
			list = (List<SharingEntry>)finderCache.getResult(
				_finderPathWithPaginationFindByTUG_C_C, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (SharingEntry sharingEntry : list) {
					if (!ArrayUtil.contains(
							toUserGroupIds, sharingEntry.getToUserGroupId()) ||
						(classNameId != sharingEntry.getClassNameId()) ||
						(classPK != sharingEntry.getClassPK())) {
		...
		if (list == null) {
			...
			if (toUserGroupIds.length > 0) {
				sb.append("(");

				sb.append(_FINDER_COLUMN_TUG_C_C_TOUSERGROUPID_7);

				sb.append(StringUtil.merge(toUserGroupIds));
			...
			try {
				...
				if (useFinderCache) {
					finderCache.putResult(
						_finderPathWithPaginationFindByTUG_C_C, finderArgs,
						list);
				}
			}
			catch (Exception exception) {
	...
	/**
	 * Removes all the sharing entries where toUserGroupId = &#63; and classNameId = &#63; and classPK = &#63; from the database.
	 *
	 * @param toUserGroupId the to user group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	...
	/**
	 * Returns the number of sharing entries where toUserGroupId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param toUserGroupId the to user group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public int countByTUG_C_C(
		long toUserGroupId, long classNameId, long classPK) {

		FinderPath finderPath = _finderPathCountByTUG_C_C;

		Object[] finderArgs = new Object[] {
			toUserGroupId, classNameId, classPK
		};
	...
	/**
	 * Returns the number of sharing entries where toUserGroupId = any &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param toUserGroupIds the to user group IDs
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	...
	public int countByTUG_C_C(
		...
		Long count = (Long)finderCache.getResult(
			_finderPathWithPaginationCountByTUG_C_C, finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				finderCache.putResult(
					_finderPathWithPaginationCountByTUG_C_C, finderArgs, count);
			}
			catch (Exception exception) {
				throw processException(exception);
			}
	...
	private static final String _FINDER_COLUMN_TUG_C_C_TOUSERGROUPID_2 =
		"sharingEntry.toUserGroupId = ? AND ";

	private static final String _FINDER_COLUMN_TUG_C_C_TOUSERGROUPID_7 =
		"sharingEntry.toUserGroupId IN (";

	private static final String _FINDER_COLUMN_TUG_C_C_CLASSNAMEID_2 =
		"sharingEntry.classNameId = ? AND ";

	private static final String _FINDER_COLUMN_TUG_C_C_CLASSPK_2 =
		"sharingEntry.classPK = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByTUG_C_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByTUG_C_C",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"toUserGroupId", "classNameId", "classPK"}, true);

		_finderPathWithoutPaginationFindByTUG_C_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByTUG_C_C",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			new String[] {"toUserGroupId", "classNameId", "classPK"}, true);

		_finderPathCountByTUG_C_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByTUG_C_C",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			new String[] {"toUserGroupId", "classNameId", "classPK"}, false);

		_finderPathWithPaginationCountByTUG_C_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByTUG_C_C",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			new String[] {"toUserGroupId", "classNameId", "classPK"}, false);
