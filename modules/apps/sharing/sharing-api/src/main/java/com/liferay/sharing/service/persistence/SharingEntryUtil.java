...
public class SharingEntryUtil {
	 ...
	 * @return the matching sharing entries
	 */
	public static List<SharingEntry> findByTUG_C_C(
		long toUserGroupId, long classNameId, long classPK) {

		return getPersistence().findByTUG_C_C(
	 ...
	 * @throws NoSuchEntryException if a matching sharing entry could not be found
	 */
	public static SharingEntry findByTUG_C_C_First(
			long toUserGroupId, long classNameId, long classPK,
			OrderByComparator<SharingEntry> orderByComparator)
		throws com.liferay.sharing.exception.NoSuchEntryException {

		return getPersistence().findByTUG_C_C_First(
	 ...
	 * @return the first matching sharing entry, or <code>null</code> if a matching sharing entry could not be found
	 */
	public static SharingEntry fetchByTUG_C_C_First(
		long toUserGroupId, long classNameId, long classPK,
		OrderByComparator<SharingEntry> orderByComparator) {

		return getPersistence().fetchByTUG_C_C_First(
			toUserGroupId, classNameId, classPK, orderByComparator);
	}
	 ...
	 * @throws NoSuchEntryException if a matching sharing entry could not be found
	 */
	public static SharingEntry findByTUG_C_C_Last(
			long toUserGroupId, long classNameId, long classPK,
			OrderByComparator<SharingEntry> orderByComparator)
		throws com.liferay.sharing.exception.NoSuchEntryException {

		return getPersistence().findByTUG_C_C_Last(
			toUserGroupId, classNameId, classPK, orderByComparator);
	}
	 ...
	 * @return the last matching sharing entry, or <code>null</code> if a matching sharing entry could not be found
	 */
	public static SharingEntry fetchByTUG_C_C_Last(
		long toUserGroupId, long classNameId, long classPK,
		OrderByComparator<SharingEntry> orderByComparator) {

		return getPersistence().fetchByTUG_C_C_Last(
			toUserGroupId, classNameId, classPK, orderByComparator);
	}
	 ...
	 * @throws NoSuchEntryException if a sharing entry with the primary key could not be found
	 */
	public static SharingEntry[] findByTUG_C_C_PrevAndNext(
			long sharingEntryId, long toUserGroupId, long classNameId,
			long classPK, OrderByComparator<SharingEntry> orderByComparator)
		throws com.liferay.sharing.exception.NoSuchEntryException {

		return getPersistence().findByTUG_C_C_PrevAndNext(
			sharingEntryId, toUserGroupId, classNameId, classPK,
			orderByComparator);
	}
	...
	public static List<SharingEntry> findByTUG_C_C(
		...
		return getPersistence().findByTUG_C_C(
			toUserGroupIds, classNameId, classPK);
	}
	...
	public static List<SharingEntry> findByTUG_C_C(
		...
		return getPersistence().findByTUG_C_C(
			toUserGroupIds, classNameId, classPK, start, end);
	}
	 ...
	 * @param classPK the class pk
	 */
	public static void removeByTUG_C_C(
		long toUserGroupId, long classNameId, long classPK) {

		getPersistence().removeByTUG_C_C(toUserGroupId, classNameId, classPK);
	}
	 ...
	 * @return the number of matching sharing entries
	 */
	public static int countByTUG_C_C(
		long toUserGroupId, long classNameId, long classPK) {

		return getPersistence().countByTUG_C_C(
			toUserGroupId, classNameId, classPK);
	}
