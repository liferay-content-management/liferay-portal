...
public class FriendlyURLEntryLocalizationUtil {
	 ...
	 * @return the matching friendly url entry localizations
	 */
	public static List<FriendlyURLEntryLocalization> findByC_C_U(
		long companyId, long classNameId, String urlTitle) {

		return getPersistence().findByC_C_U(companyId, classNameId, urlTitle);
	}
	...
	public static List<FriendlyURLEntryLocalization> findByC_C_U(
		...
		return getPersistence().findByC_C_U(
	 ...
	 * @throws NoSuchFriendlyURLEntryLocalizationException if a matching friendly url entry localization could not be found
	 */
	public static FriendlyURLEntryLocalization findByC_C_U_First(
			long companyId, long classNameId, String urlTitle,
			OrderByComparator<FriendlyURLEntryLocalization> orderByComparator)
		throws com.liferay.friendly.url.exception.
			NoSuchFriendlyURLEntryLocalizationException {

		return getPersistence().findByC_C_U_First(
	 ...
	 * @return the first matching friendly url entry localization, or <code>null</code> if a matching friendly url entry localization could not be found
	 */
	public static FriendlyURLEntryLocalization fetchByC_C_U_First(
		long companyId, long classNameId, String urlTitle,
		OrderByComparator<FriendlyURLEntryLocalization> orderByComparator) {

		return getPersistence().fetchByC_C_U_First(
			companyId, classNameId, urlTitle, orderByComparator);
	}
	 ...
	 * @throws NoSuchFriendlyURLEntryLocalizationException if a matching friendly url entry localization could not be found
	 */
	public static FriendlyURLEntryLocalization findByC_C_U_Last(
			long companyId, long classNameId, String urlTitle,
			OrderByComparator<FriendlyURLEntryLocalization> orderByComparator)
		throws com.liferay.friendly.url.exception.
			NoSuchFriendlyURLEntryLocalizationException {

		return getPersistence().findByC_C_U_Last(
			companyId, classNameId, urlTitle, orderByComparator);
	}
	 ...
	 * @return the last matching friendly url entry localization, or <code>null</code> if a matching friendly url entry localization could not be found
	 */
	public static FriendlyURLEntryLocalization fetchByC_C_U_Last(
		long companyId, long classNameId, String urlTitle,
		OrderByComparator<FriendlyURLEntryLocalization> orderByComparator) {

		return getPersistence().fetchByC_C_U_Last(
			companyId, classNameId, urlTitle, orderByComparator);
	}
	 ...
	 * @throws NoSuchFriendlyURLEntryLocalizationException if a friendly url entry localization with the primary key could not be found
	 */
	public static FriendlyURLEntryLocalization[] findByC_C_U_PrevAndNext(
		...
		return getPersistence().findByC_C_U_PrevAndNext(
	 ...
	 * @param urlTitle the url title
	 */
	public static void removeByC_C_U(
		long companyId, long classNameId, String urlTitle) {

		getPersistence().removeByC_C_U(companyId, classNameId, urlTitle);
	}
	 ...
	 * @return the number of matching friendly url entry localizations
	 */
	public static int countByC_C_U(
		long companyId, long classNameId, String urlTitle) {

		return getPersistence().countByC_C_U(companyId, classNameId, urlTitle);
	}
