...
/**
 * Provides the local service interface for PermissionTemplate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PermissionTemplateLocalServiceUtil
 * @generated
 */
@CTAware
@ProviderType
...
public interface PermissionTemplateLocalService
	extends BaseLocalService, CTService<PermissionTemplate>,
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PermissionTemplate> getPermissionTemplates(int start, int end);
