...
/**
 * Provides the local service utility for PermissionTemplate. This utility wraps
 * <code>com.liferay.permission.template.service.impl.PermissionTemplateLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PermissionTemplateLocalServiceUtil {
	...
	public static PermissionTemplate addPermissionTemplate(
		...
		return getService().addPermissionTemplate(permissionTemplate);
	}
	 ...
	 */
	public static PermissionTemplate createPermissionTemplate(
		long permissionTemplateId) {

		return getService().createPermissionTemplate(permissionTemplateId);
	}
	 ...
	 */
	public static PermissionTemplate deletePermissionTemplate(
			long permissionTemplateId)
		throws PortalException {

		return getService().deletePermissionTemplate(permissionTemplateId);
	}
	...
	public static PermissionTemplate deletePermissionTemplate(
		...
		return getService().deletePermissionTemplate(permissionTemplate);
	}
	 ...
	 * @throws PortalException if a permission template with the primary key could not be found
	 */
	public static PermissionTemplate getPermissionTemplate(
			long permissionTemplateId)
		throws PortalException {

		return getService().getPermissionTemplate(permissionTemplateId);
	}
	 ...
	 */
	public static List<PermissionTemplate> getPermissionTemplates(
		int start, int end) {

		return getService().getPermissionTemplates(start, end);
	}
	 ...
	 */
	public static int getPermissionTemplatesCount() {
		return getService().getPermissionTemplatesCount();
	}
	...
	public static PermissionTemplate updatePermissionTemplate(
		...
		return getService().updatePermissionTemplate(permissionTemplate);
	}

	public static PermissionTemplateLocalService getService() {
		return _service;
	}

	public static void setService(PermissionTemplateLocalService service) {
		_service = service;
	}

	private static volatile PermissionTemplateLocalService _service;
