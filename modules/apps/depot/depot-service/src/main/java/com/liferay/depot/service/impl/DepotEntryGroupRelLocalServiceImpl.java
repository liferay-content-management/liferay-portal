...
public class DepotEntryGroupRelLocalServiceImpl
	...
	public DepotEntryGroupRel deleteDepotEntryGroupRel(
		...
		DepotEntryGroupRel depotEntryGroupRel =
			depotEntryGroupRelPersistence.fetchByPrimaryKey(
		...
		return super.deleteDepotEntryGroupRel(depotEntryGroupRelId);
	}
	...
	private void _connectLayoutSetPrototypeGroups(
		...
		for (LayoutSet layoutSet : layoutSets) {
			depotEntryGroupRelLocalService.addDepotEntryGroupRel(
